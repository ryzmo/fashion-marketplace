...
export default function InfografisLimbahTekstil() {
  ...
  {isSearchVisible && (
    ...
    >
      ...
      <div className="container mx-auto text-center px-6 lg:px-16 mt-10 py-10">
        {/* Infografis Section */}
        <div className="bg-white p-8 rounded-3xl shadow-xl text-center w-fit mx-auto">
          <Image 
            src="/infografis.png" 
        ...
        <section className="mt-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="bg-gray-50 p-6 rounded-2xl shadow-md text-left">
              <h3 className="text-xl font-semibold text-yellow-600 mb-2">Polusi Air</h3>
              <p className="text-gray-600">
                Limbah tekstil mencemari sungai dan lautan dengan pewarna kimia dan serat mikroplastik.
              </p>
            </div>
            <div className="bg-gray-50 p-6 rounded-2xl shadow-md text-left">
              <h3 className="text-xl font-semibold text-yellow-600 mb-2">Emisi Karbon</h3>
              <p className="text-gray-600">
                Industri fashion menghasilkan lebih banyak karbon daripada penerbangan dan pelayaran digabungkan.
              </p>
            </div>
            <div className="bg-gray-50 p-6 rounded-2xl shadow-md text-left">
              <h3 className="text-xl font-semibold text-yellow-600 mb-2">Limbah Pakaian</h3>
              <p className="text-gray-600">
                85% pakaian berakhir di tempat pembuangan sampah setiap tahunnya, meningkatkan pencemaran tanah.
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="mt-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="bg-white p-6 rounded-2xl shadow-lg text-left">
              <h3 className="text-xl font-semibold text-green-700 mb-2">Pilih Produk Berkelanjutan</h3>
              <p className="text-gray-600">
                Beli pakaian dari bahan ramah lingkungan atau yang dapat didaur ulang.
              </p>
            </div>
            <div className="bg-white p-6 rounded-2xl shadow-lg text-left">
              <h3 className="text-xl font-semibold text-green-700 mb-2">Daur Ulang dan Donasi</h3>
              <p className="text-gray-600">
                Jangan buang pakaian lama—donasikan atau ubah menjadi sesuatu yang baru.
              </p>
            </div>
            <div className="bg-white p-6 rounded-2xl shadow-lg text-left">
              <h3 className="text-xl font-semibold text-green-700 mb-2">Kurangi Fast Fashion</h3>
              <p className="text-gray-600">
                Belilah pakaian dengan kualitas tinggi yang tahan lama, bukan hanya tren sesaat.
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="mt-16 text-center">
          <h2 className="text-3xl font-bold text-green-800 mb-4">
            Ayo Berkontribusi untuk Bumi!
          </h2>
          <p className="text-gray-600 max-w-xl mx-auto mb-6">
            Bergabunglah dalam gerakan fashion berkelanjutan. Tukar, donasi, atau perbaiki pakaianmu sekarang!
          </p>
          <Link href="/#siklus">
            <button className="bg-yellow-500 text-gray-800 px-8 py-3 rounded-full shadow-md hover:bg-yellow-600 transition duration-300">
              Lihat Produk Berkelanjutan
            </button>
          </Link>
        </section>
      </div>
